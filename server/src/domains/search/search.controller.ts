...
import { calculateOffset, getTotalPageCount } from "../../utils/pagination.ts";
...
export const searchByProfile = async (req: Request, res: Response) => {
  ...
  if (validatedData.page > totalPageCount) {
    return new AppError("Invalid page number", 400);
  }
